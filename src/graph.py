...
def build_relation_adjacencies(
    ...
    """Build normalized sparse adjacencies for relation-aware experiments."""
    ap_adj = build_bipartite_adjacency(num_authors, num_papers, train_edges)
    ...
    return {"author_paper": ap_adj, "author_author": aa_adj, "paper_paper": pp_adj}
